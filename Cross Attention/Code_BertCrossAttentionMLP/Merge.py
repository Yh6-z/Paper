...
def merge_predictions():
    ...
    # 保存合并结果到 CSV
    output_test_path = os.path.join(output_dir, "merged_test_predictions_mlpCA.csv")
    merged_df_test.to_csv(output_test_path, index=False)
    
    output_train_path = os.path.join(output_dir, "merged_train_predictions_mlpCA.csv")
